const country_and_states = {
  ...
  states: {
    AF: [
      ...
      { name: "Farah", code: "FRA" },
      { name: "Faryāb", code: "FYB" },
      { name: "Ghaznī", code: "GHA" },
      { name: "Ghōr", code: "GHO" },
      ...
      { name: "Nīmrōz", code: "NIM" },
      { name: "Nūristan", code: "NUR" },
      { name: "Paktiya", code: "PIA" },
      { name: "Paktīka", code: "PKA" },
      { name: "Panjshayr", code: "PAN" },
      { name: "Parwan", code: "PAR" },
      { name: "Samangan", code: "SAM" },
      { name: "Sar-e Pul", code: "SAR" },
      { name: "Takhar", code: "TAK" },
      { name: "Uruzgan", code: "URU" },
      { name: "Wardak", code: "WAR" },
      { name: "Zabul", code: "ZAB" },
    ],
    AX: [{ name: "Åland Islands", code: "Åland Islands" }],
    AL: [
      { name: "Berat", code: "01" },
      { name: "Dibër", code: "09" },
      { name: "Durrës", code: "02" },
    ...
    AS: [{ name: "American Samoa", code: "American Samoa" }],
    AD: [
    ...
    AI: [{ name: "Anguilla", code: "Anguilla" }],
    AQ: [{ name: "Antarctica", code: "Antarctica" }],
    AG: [
      { name: "Barbuda", code: "10" },
      { name: "Redonda", code: "11" },
      { name: "Saint George", code: "03" },
      { name: "Saint John", code: "04" },
      { name: "Saint Mary", code: "05" },
      { name: "Saint Paul", code: "06" },
      { name: "Saint Peter", code: "07" },
      { name: "Saint Philip", code: "08" },
    ],
    AR: [
    ...
    AM: [
      { name: "Aragac̣otn", code: "AG" },
      { name: "Ararat", code: "AR" },
      { name: "Armavir", code: "AV" },
      { name: "Erevan", code: "ER" },
      { name: "Geġark'unik'", code: "GR" },
      { name: "Kotayk'", code: "KT" },
      { name: "Loṙi", code: "LO" },
      { name: "Syunik'", code: "SU" },
      { name: "Tavuš", code: "TV" },
      { name: "Vayoć Jor", code: "VD" },
      { name: "Širak", code: "SH" },
    ],
    AW: [{ name: "Aruba", code: "Aruba" }],
    AU: [
    ...
    BQ: [{ name: "Caribbean Netherlands", code: "Caribbean Netherlands" }],
    BA: [
    ...
    BV: [{ name: "Bouvet Island", code: "Bouvet Island" }],
    BR: [
      { name: "Acre", code: "AC" },
    ...
    KY: [{ name: "Cayman Islands", code: "Cayman Islands" }],
    CF: [
    ...
    CX: [{ name: "Christmas Island", code: "Christmas Island" }],
    CC: [{ name: "Cocos (Keeling) Islands", code: "Cocos (Keeling) Islands" }],
    CO: [
    ...
    CK: [{ name: "Cook Islands", code: "Cook Islands" }],
    CR: [
    ...
    FO: [{ name: "Faroe Islands", code: "Faroe Islands" }],
    FJ: [
      { name: "Ba", code: "01" },
      { name: "Bua", code: "02" },
    ...
    GF: [{ name: "French Guiana", code: "French Guiana" }],
    PF: [{ name: "French Polynesia", code: "French Polynesia" }],
    TF: [
      {
    ...
    GI: [{ name: "Gibraltar", code: "Gibraltar" }],
    GR: [
    ...
    GL: [{ name: "Greenland", code: "Greenland" }],
    GD: [
    ...
    GP: [{ name: "Guadeloupe", code: "Guadeloupe" }],
    GU: [{ name: "Guam", code: "Guam" }],
    GT: [
    ...
    GG: [{ name: "Guernsey", code: "Guernsey" }],
    GN: [
    ...
    VA: [{ name: "Vatican City Holy See", code: "Vatican City Holy See" }],
    HN: [
    ...
    IM: [{ name: "Isle of Man", code: "Isle of Man" }],
    IL: [
    ...
    MQ: [{ name: "Martinique", code: "Martinique" }],
    MR: [
    ...
    MS: [{ name: "Montserrat", code: "Montserrat" }],
    MA: [
    ...
    AN: [{ name: "Netherlands Antilles", code: "Netherlands Antilles" }],
    NC: [{ name: "New Caledonia", code: "New Caledonia" }],
    NZ: [
    ...
    NU: [{ name: "Niue", code: "Niue" }],
    NF: [{ name: "Norfolk Island", code: "Norfolk Island" }],
    MP: [
    ...
    PS: [{ name: "Palestine", code: "Palestine" }],
    PA: [
    ...
    PN: [{ name: "Pitcairn Islands", code: "Pitcairn Islands" }],
    PL: [
    ...
    PR: [{ name: "Puerto Rico", code: "Puerto Rico" }],
    QA: [
    ...
    BL: [{ name: "Saint Barthelemy", code: "Saint Barthelemy" }],
    SH: [{ name: "Saint Helena", code: "Saint Helena" }],
    KN: [
    ...
    MF: [{ name: "Saint Martin", code: "Saint Martin" }],
    PM: [
    ...
    CS: [{ name: "Serbia and Montenegro", code: "Serbia and Montenegro" }],
    SC: [
    ...
    SX: [{ name: "Sint Maarten", code: "Sint Maarten" }],
    SK: [
    ...
    SJ: [{ name: "Svalbard and Jan Mayen", code: "Svalbard and Jan Mayen" }],
    SZ: [
    ...
    GB: [
      ...
      { name: "Armagh City, Banbridge and Craigavon", code: "ABC" },
      { name: "Belfast City", code: "BFS" },
      { name: "Causeway Coast and Glens", code: "CCG" },
      { name: "Derry and Strabane", code: "DRS" },
      ...
      { name: "Barking and Dagenham", code: "BDG" },
      { name: "Barnet", code: "BNE" },
      { name: "Bexley", code: "BEX" },
      { name: "Brent", code: "BEN" },
      { name: "Bromley", code: "BRY" },
      { name: "Camden", code: "CMD" },
      { name: "Croydon", code: "CRY" },
      { name: "Ealing", code: "EAL" },
      { name: "Enfield", code: "ENF" },
      { name: "Greenwich", code: "GRE" },
      { name: "Hackney", code: "HCK" },
      { name: "Hammersmith and Fulham", code: "HMF" },
      { name: "Haringey", code: "HRY" },
      { name: "Harrow", code: "HRW" },
      { name: "Havering", code: "HAV" },
      { name: "Hillingdon", code: "HIL" },
      { name: "Hounslow", code: "HNS" },
      { name: "Islington", code: "ISL" },
      { name: "Kensington and Chelsea", code: "KEC" },
      { name: "Kingston upon Thames", code: "KTT" },
      { name: "Lambeth", code: "LBH" },
      { name: "Lewisham", code: "LEW" },
      { name: "Merton", code: "MRT" },
      { name: "Newham", code: "NWM" },
      { name: "Redbridge", code: "RDB" },
      { name: "Richmond upon Thames", code: "RIC" },
      { name: "Southwark", code: "SWK" },
      { name: "Sutton", code: "STN" },
      { name: "Tower Hamlets", code: "TWH" },
      { name: "Waltham Forest", code: "WFT" },
      { name: "Wandsworth", code: "WND" },
      { name: "Westminster", code: "WSM" },
      ...
      { name: "Blaenau Gwent", code: "BGW" },
      { name: "Bournemouth, Christchurch and Poole", code: "BCP" },
      { name: "Bracknell Forest", code: "BRC" },
      { name: "Bridgend [Pen-y-bont ar Ogwr GB-POG]", code: "BGE" },
      { name: "Brighton and Hove", code: "BNH" },
      { name: "Bristol, City of", code: "BST" },
      { name: "Caerphilly [Caerffili GB-CAF]", code: "CAY" },
      { name: "Cardiff [Caerdydd GB-CRD]", code: "CRF" },
      { name: "Carmarthenshire [Sir Gaerfyrddin GB-GFY]", code: "CMN" },
      { name: "Central Bedfordshire", code: "CBF" },
      { name: "Ceredigion [Sir Ceredigion]", code: "CGN" },
      { name: "Cheshire East", code: "CHE" },
      { name: "Cheshire West and Chester", code: "CHW" },
      { name: "Conwy", code: "CWY" },
      { name: "Cornwall", code: "CON" },
      { name: "Darlington", code: "DAL" },
      { name: "Denbighshire [Sir Ddinbych GB-DDB]", code: "DEN" },
      { name: "Derby", code: "DER" },
      { name: "Durham, County", code: "DUR" },
      { name: "East Riding of Yorkshire", code: "ERY" },
      { name: "Flintshire [Sir y Fflint GB-FFL]", code: "FLN" },
      { name: "Gwynedd", code: "GWN" },
      { name: "Halton", code: "HAL" },
      { name: "Hartlepool", code: "HPL" },
      { name: "Herefordshire", code: "HEF" },
      { name: "Isle of Anglesey [Sir Ynys Môn GB-YNM]", code: "AGY" },
      { name: "Isle of Wight", code: "IOW" },
      { name: "Isles of Scilly", code: "IOS" },
      { name: "Kingston upon Hull", code: "KHL" },
      { name: "Leicester", code: "LCE" },
      { name: "Luton", code: "LUT" },
      { name: "Medway", code: "MDW" },
      { name: "Merthyr Tydfil [Merthyr Tudful GB-MTU]", code: "MTY" },
      { name: "Middlesbrough", code: "MDB" },
      { name: "Milton Keynes", code: "MIK" },
      { name: "Monmouthshire [Sir Fynwy GB-FYN]", code: "MON" },
      {
        name: "Neath Port Talbot [Castell-nedd Port Talbot GB-CTL]",
        code: "NTL",
      },
      { name: "Newport [Casnewydd GB-CNW]", code: "NWP" },
      ...
      { name: "Wrexham [Wrecsam GB-WRC]", code: "WRX" },
      { name: "York", code: "YOR" },
    ],
    US: [
    ...
    UM: [{ name: "U.S. Outlying Islands", code: "U.S. Outlying Islands" }],
    UY: [
    ...
    VG: [{ name: "Virgin Islands, British", code: "Virgin Islands, British" }],
    VI: [{ name: "Virgin Islands, U.S", code: "Virgin Islands, U.S" }],
    WF: [{ name: "Wallis and Futuna", code: "Wallis and Futuna" }],
    EH: [{ name: "Western Sahara", code: "Western Sahara" }],
    YE: [
...
export const country_list = country_and_states.country;
export const state_list = country_and_states.states;
